...
@Directive({ selector: '[claimGranted]'})
export class ClaimGrantedDirective implements OnDestroy {
  ...
  @Input() set claimGranted([claim, value, evaluatedOnLoginOnly]: [string, string, boolean]) {
